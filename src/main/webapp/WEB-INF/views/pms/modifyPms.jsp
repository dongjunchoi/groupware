...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">일감 수정페이지</h3>
			<div class="actions pull-right">
			</div>
		</div>
		<div class="panel-body" style="display: block; min-height: 900px; min-width: 500px;">
			<form action="/pms/modifyPms" method="post" id="frm"  enctype="multipart/form-data"
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="date" id="s_dt" name="s_dt" 
						value='<fmt:formatDate value="${workVo.s_dt}" pattern="yyyy-MM-dd"/>' class="form-control">
					</div>
					<label class="col-sm-1 control-label">종료일자</label>
					<div class="col-sm-2">
						<input type="date" id="e_dt" name="e_dt" 
						value='<fmt:formatDate value="${workVo.e_dt}" pattern="yyyy-MM-dd"/>' class="form-control">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="work_nm" name="work_nm" value="${workVo.work_nm }"class="form-control">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<textarea id="summernote" name="cont" style="height: 100%;">${workVo.cont }</textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="est_time" name="est_time"   value="${workVo.est_time }" class="form-control">
					</div>
					<label class="col-sm-1 control-label">진척도</label>
					<div class="col-sm-2">
						<input type="text" id="prog" name="prog"   value="${workVo.prog }" class="form-control">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label">첨부파일 등록</label>
					<div class="col-sm-5">
				...
				<div >
					...
					<input type="hidden" id="pms_no" name="pms_no" value="${workVo.pms_no}">
					<input type="hidden" id="work_no" name="work_no" value="${workVo.work_no}">
				</div>
