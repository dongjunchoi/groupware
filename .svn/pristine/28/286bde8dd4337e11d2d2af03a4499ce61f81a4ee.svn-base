			...
			<form action="/scd/registCalendar" method="post" id="frm"
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="date" id="s_dt" name="s_dt"
							value='<fmt:formatDate value="${s_dt}" pattern="yyyy-MM-dd"/>'
							class="form-control">
					</div>
					<label class="col-sm-1 control-label">종료일자</label>
					<div class="col-sm-2">
						<input type="date" id="e_dt" name="e_dt"
							value='<fmt:formatDate value="${e_dt}" pattern="yyyy-MM-dd"/>'
							class="form-control">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<button type="submit" id="submit"
						class="btn btn-success btn-square">저장</button>
				</div>
