...
<script type="text/javascript">
	...
	function pagingVacAjax(page, pageSize) {
		...
		$.ajax({
			url : "/vacController/pagingVacAjaxHtml",
			tpye : "POST",
			data : {
				"page" : page,
				"pageSize" : pageSize,
...
<div id="container">
	...
	<form id="frm1" action="/vacController/vaclistExcel">
	</form>
				...
				<div class="panel-heading">
					<c:choose>
						<c:when test="${S_USER.emp_no == 0 }">
							<h3 class="panel-title">연차 현황</h3>
						</c:when>
						<c:otherwise>
							<h3 class="panel-title">${S_USER.ko_nm } 연차 현황</h3>
						</c:otherwise>
					</c:choose>
				</div>
						...
						<div role="grid" id="example_wrapper"
							...
							<div class="row">
								<div class="col-xs-6" style="float: left;">
									<div class="dataTables_length" id="example_length"
										style="padding-left: 15px; width:1156px;">
										...
										<span style="margin-left:85px;">
											...
											<span id="searchDate" style="display: none;"> 
												...
												<c:otherwise>
													...
													<span id="searchDate" style="display: block; width: 1000px;"> 
														<label>기간:
														<input style="width: 150px;" id="DateSearching1" type="date"
														class="form-control input-sm" aria-controls="example" onchange="dateSearching()">											
														~ 
											...
											<label style="float:right;"> <select
							...
							<div class="array_option" id="ConditionBox"
								style="display: none; background: #eee; border-radius: 4px; box-shadow: 1px 2px 10px rgb(0 0 0/ 40%); 
										width: 100px; z-index: 3; position: absolute; margin-left:14px; margin-top:35px;">
